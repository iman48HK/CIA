...
const features = [
  {
    ...
    text: 'Create your account and start analyzing projects in minutes.',
  },
  {
    title: 'AI-assisted reviews',
    text: 'Surface key compliance and delivery insights across your files.',
  },
  {
    title: 'Secure collaboration',
    text: 'Share a trusted workspace for your project stakeholders.',
  },
]
...
async function submit() {
  ...
  try {
    ...
    error.value = apiErrorMessage(e, 'Sign up failed')
  } finally {
    loading.value = false
  }
}
  ...
  <div class="login-split">
    <aside class="login-aside" aria-label="Product overview">
      ...
      <h1 class="aside-headline">
        Start with <span class="aside-accent">Construction</span> Intelligence
      </h1>
    ...
    <main class="login-main">
      ...
      <p class="login-lead">Set up your account to continue</p>
